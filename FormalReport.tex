...
\begin{document}
    ...
    \section{Introduction}
        \subsection{Background}
            In 1887 physicist Heinrich Hertz noticed that exposing a spark gap to UV light would increase the maximum length of spark that could be achieved for a given voltage \reference{reference:uvPaper}{Hertz, Heinrich}{1887}. Alexander Stoletov continued to study the effect, discovering that the intensity of the light on the metal was proportional to the induced current. Based off of Max Planck's work, Albert Einstien hypothosised that because energy was quantized, a threshold energy was required before an electron could be released. As a photon's energy is related to it's frequency and wavelength only wavelenghts above a threshold can create a current in a material. \reference{reference:physicsHypertextbook}{Glenn Elert}{1998-2026}
